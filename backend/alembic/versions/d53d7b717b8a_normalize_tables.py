...
down_revision: str | Sequence[str] | None = "6d0eb3f3fee2"
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_lessons_subject_id", "lessons", "subjects", ["subject_id"], ["id"]
    )
    op.create_foreign_key("fk_lessons_room_id", "lessons", "rooms", ["room_id"], ["id"])
    op.create_foreign_key(
        "fk_lessons_teacher_id", "lessons", "teachers", ["teacher_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "lessons", sa.Column("room", sa.VARCHAR(), autoincrement=False, nullable=False)
    )
    op.add_column(
        "lessons",
